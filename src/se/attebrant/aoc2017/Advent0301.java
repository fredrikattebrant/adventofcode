...
public class Advent0301 {
  ...
  private class Cell {
    ...
    public String toString() {
      String asString = String.format("%2d (%2d,%2d)", id, row, col);
      return asString;
      // return id + " (" + row + "," + col + ")";
    }
  }
  ...
  public void run() {
    // int numberOfCells = 277678;
    int numberOfCells = 289326;
    initCells(numberOfCells);
    printCells();
    Cell cell = cells.get(numberOfCells);
    System.out.println("Cell: " + cell + " => " + Math.abs(cell.getCol() + cell.getRow()));
  ...
  private void printCells() {
    ...
    for (Integer row = minRow; row < rowKeySet.size(); row++) {
      ...
      String separator = "";
      for (Integer col = minCol; col < colKeySet.size(); col++) {
